...
def negamax_no_pruning(game, depth, origDepth, scoring, tt=None):
    """
    ...
    for move in possible_moves:
        ...
        move_alpha = -negamax_no_pruning(game, depth - 1, origDepth, scoring, tt)
